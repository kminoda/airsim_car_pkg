...
private:
    ...
    nav_msgs::Odometry get_odom_msg_from_airsim_state(const msr::airlib::CarState& drone_state) const;
...
private:
    ...
    struct CarROS
    {
        ...
        /// State
        msr::airlib::CarState curr_drone_state;
    ...
    // todo for multiple drones with multiple sensors, this won't scale. make it a part of CarROS?
